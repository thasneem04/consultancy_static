...
export const stats = [
  ...
  { value: '06', label: 'Core solution areas', detail: 'Focused enterprise advisory' },
  { value: '2030', label: 'Vision aligned', detail: 'Transformation-led consulting' },
  { value: '360', label: 'Consulting support', detail: 'From strategy to execution' }
];
...
export const solutions = [
  {
    ...
    benefits: ['Market entry strategy', 'Vendor registration support', 'IKTVA and local content advisory', 'Operational efficiency'],
    details: [
  ...
  },
  {
    ...
    benefits: ['Business automation', 'ERP and IT solutions', 'CRM and SaaS enablement', 'AI-enabled office setup'],
    details: [
  ...
  },
  {
    ...
    benefits: ['Recruitment solutions', 'Skilled and unskilled manpower planning', 'Saudization advisory', 'HR policy development'],
    details: [
  ...
  },
  {
    ...
    benefits: ['MISA registration', 'Government approval guidance', 'Legal documentation assistance', 'Compliance readiness'],
    details: [
  ...
  },
  {
    ...
    benefits: ['Feasibility studies', 'Market analysis', 'Technical advisory', 'Resource planning'],
    details: [
  ...
  },
  {
    ...
    benefits: ['Solar and wind advisory', 'Green project planning', 'Investment planning', 'Sustainable energy strategy'],
    details: [
...
export const industries = [
  { title: 'Oil & Gas', icon: Factory, text: 'Energy-sector growth, supplier readiness, local content, and operational improvement.' },
  { title: 'Digital Transformation', icon: Zap, text: 'Automation, ERP, SaaS, CRM, AI-enabled workflows, and digital strategy.' },
  { title: 'Human Resources', icon: UsersRound, text: 'Recruitment, manpower supply, Saudization, HR policy, and workforce planning.' },
  { title: 'Regulatory Compliance', icon: Landmark, text: 'Market entry, government approvals, company formation, and documentation.' },
  { title: 'Renewable Energy', icon: Leaf, text: 'Solar, wind, green energy project advisory, and sustainable investment planning.' },
  { title: 'Business Strategy', icon: BarChart3, text: 'Feasibility, positioning, market entry, performance improvement, and growth roadmaps.' }
];
...
export const ethics = ['Client confidentiality', 'Transparent pricing', 'Professional conduct', 'Legal compliance', 'Ethical business practices'];

export const expansion = ['Branch offices across KSA', 'International partnerships', 'Corporate training division', 'Investment advisory wing'];
...
export const testimonials = [
  {
    quote: 'MNCS brings clarity to Saudi market entry with practical advisory, strong local context, and disciplined execution.',
    name: 'Strategy Director',
    role: 'Industrial Services Client'
  },
  {
    quote: 'Their process connects feasibility, compliance, people, and implementation in a way that keeps momentum moving.',
...
export const quickContacts = [
  ...
  { title: 'Strategy Desk', icon: Target, value: 'Business advisory enquiries' }
];
