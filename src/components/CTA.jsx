    ...
    <section className="section-shell py-10 md:py-16">
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-r from-cobalt via-skybrand to-magenta p-8 shadow-glow md:p-12">
        ...
        <div className="relative z-10 max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-white/75">Partner with MNCS</p>
          ...
          <p className="mt-5 text-base leading-8 text-white/85">
            From feasibility to compliance, workforce readiness, digital transformation, and execution, MNCS helps companies move with clarity.
          </p>
          <div className="mt-7">
