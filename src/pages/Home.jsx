...
import { process, solutions, stats, strengths, testimonials, vision2030 } from '../data/siteContent.js';

export default function Home() {
  return (
    <MotionPage>
      <section className="relative min-h-[92vh] overflow-hidden pt-24">
        <img src="/mncs-hero.png" alt="" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="section-shell relative z-10 flex min-h-[calc(92vh-6rem)] items-center py-20">
          <motion.div
            className="max-w-4xl"
      ...
      <Section eyebrow="Business Process" title="A structured consulting model for measurable progress.">
        <ProcessTimeline steps={process} />
      </Section>

      <Section eyebrow="Client Perspective" title="Consulting designed to create confidence.">
